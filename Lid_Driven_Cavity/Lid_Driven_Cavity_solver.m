...
colormap turbo
colorbar
title('X component of velocity (U)')
xlabel('X')
ylabel('Y')
yticks(0:0.2:1)
axis equal
...
colormap turbo
colorbar
title('Y component of velocity (V)')
xlabel('X')
ylabel('Y')
yticks(0:0.2:1)
axis equal
...
title('Lid driven cavity - U vs y (x = 0.5) - Re = 100')
xlabel('U/U_{max}')
ylabel('Y')
axis square
ax = gca; % Get the current axes
...
plot(xcl11,vcl11,'b ')
ylim([-0.26 0.2])
title('Lid driven cavity - V vs x (y = 0.5) - Re = 100')
legend('Ghia','51x51 grid','31x31 grid','11x11 grid')
xlabel('X')
ylabel('V/U_{max}')
axis square
